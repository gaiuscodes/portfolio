...
## 🚀 Live Demo
🔗 **View Portfolio:** [Click Here](https://gaiuscodes.github.io/portfolio/)
...
- **Contact Form** connected to a backend for handling messages.
...
- **PHP** – Backend form handling (with Vercel serverless `/api/contact` fallback).
